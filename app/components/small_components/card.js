...
const Card = ({ img, title, para, will_wrap }) => {
  return (
    <div key={title} className={`bg-white rounded-3xl overflow-hidden py-4 border-[1px] border-gray-300 grid  place-content-center ${will_wrap ? 'sm:w-[46%] sm:min-h-[60vh] sm:py-2 md:w-[46%]' : 'sm:p-[5vw] md:p-6'}`}>
